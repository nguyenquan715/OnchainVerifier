...
export const CURRENCY_DECIMAL = Object.freeze({
  [CHAIN.POLYGON]: Object.values(CURRENCY_INFO.POLYGON).reduce(
    (obj, { address, decimal }) => {
      obj[address] = decimal;
      return obj;
    },
  ...
  [CHAIN.ETHEREUM]: Object.values(CURRENCY_INFO.ETHEREUM).reduce(
    (obj, { address, decimal }) => {
      obj[address] = decimal;
      return obj;
    },
...
export const DEX_ADDRESS = Object.freeze({
  [CHAIN.POLYGON]: {
    UNISWAP_UNIVERSAL_ROUTER:
      "0x4c60051384bd2d3c01bfc845cf5f4b44bcbe9de5".toLowerCase(),
    UNISWAP_V3_NFT_POSITION_MANAGER:
      "0xC36442b4a4522E871399CD717aBDD847Ab11FE88".toLowerCase(),
  },
  [CHAIN.ETHEREUM]: {
    UNISWAP_UNIVERSAL_ROUTER:
